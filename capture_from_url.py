...
def search_selenium(search_name, search_path, search_limit):
    ...
    for name in search_list:
        for url in [
            "https://www.google.com/search?q=" + str(name) + "&hl=ko&tbm=isch",
            "https://www.bing.com/images/search?q=" + str(name) + "&form=HDRSC3&first=1&tsc=ImageBasicHover",
            "https://search.daum.net/search?w=img&nil_search=btn&DA=NTB&enc=utf8&q=" + str(name),
            "https://image.baidu.com/search/index?tn=baiduimage&ps=1&ct=201326592&lm=-1&cl=2&nc=1&ie=utf-8&word=" + str(name) + "&ie=utf-8&ie=utf-8",
            "https://search.naver.com/search.naver?where=image&sm=tab_jum&query=" + str(name),
        ]:
            ...
            for i in range(search_limit):
                try:
                    ...
                    os.makedirs("/home/hong/PycharmProjects/pythonProject/alexNet/input/images/"+search_path, exist_ok=True)
